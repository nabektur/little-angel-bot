...
class Database:
    ...
    async def start(self):
        ...
        await self.execute("CREATE TABLE IF NOT EXISTS spamtexts_ordinary (text varchar);")
        await self.execute("CREATE TABLE IF NOT EXISTS spamtexts_nsfw (text varchar);")
