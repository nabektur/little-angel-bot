...
class Settings(BaseSettings):
    ...
    VOICE_VERIFICATION_CHANNEL_ID: SecretStr
    PING_VERIFICATION_CHANNEL_ID: SecretStr

    BOT_PREFIX: str = "."
    LITTLE_ANGEL_COLOR: int = 0x5b00c1
    ACTIVITY_NAMES: cycle = cycle([{"name": "<a:black_melting_heart:1410555793199202376> Memento Mori", "streaming_url": ""}, {"name": "няшных котиков", "streaming_url": "https://www.twitch.tv/jasteeq"}])
