...
class Settings(BaseSettings):
    ...
    ADS_CHANNELS_IDS: typing.List[int] = [1434948088199516302, 1441759667217764462, 1434634895602225172]
    # ROFLS_CHANNEL_ID: SecretStr

    BOT_PREFIX: str = "."
    LITTLE_ANGEL_COLOR: int = 0x5b00c1
    ACTIVITY_NAMES: cycle = cycle([{"name": "🖤 Memento Mori", "streaming_url": ""}, {"name": "няшные котики", "streaming_url": "https://www.twitch.tv/jasteeq"}])
